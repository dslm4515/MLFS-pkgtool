...
bash scripts/tc-which.sh        && echo "32/36: which"                   >> ${PRGRSS}/tc.progress &&
bash scripts/tc-tar-1.13.sh     && echo "33/36: Tar-1.13"                >> ${PRGRSS}/tc.progress &&
bash scripts/tc-util-linux.sh   && echo "34/36: Util-Linux"              >> ${PRGRSS}/tc.progress &&
bash scripts/tc-tree.sh         && echo "35/36: Tree"                    >> ${PRGRSS}/tc.progress &&
bash scripts/tc-pkgtools.sh     && echo "26/36: Pkgtools"                >> ${PRGRSS}/tc.progress &&
